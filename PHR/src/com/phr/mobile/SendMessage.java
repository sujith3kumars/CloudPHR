...
import java.net.URL;public class SendMessage {	public static String sendSms(String number, String msg) {
		try {
			// Construct data
			// Send data
			String apiKey = "M7fCAj9UHTIK0dLwY4SsOuXiGRoQghpcePtr5qNylkbmJFVDavgYJF35EXAoQdprjRny7ctVTUvGHbaK";
